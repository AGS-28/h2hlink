                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="/" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">H2HLink.com</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <?php if ($check_link['status'] == 99) { ?>
                                            
                                        <?php } else if ($check_link['status'] == 1) { ?>
                                            ...
                                            <form class="custom-form mt-4" action="/">
                                                ...
                                                <div class="mb-3">
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name ="retpassword" id="retpassword2" class="form-control" placeholder="Ulangi password" aria-label="Password" aria-describedby="password-addon2">
                                                ...
                                                <div class="mb-3 mt-4">
                                                    ...
                                                    <button id="btn-reset" class="btn btn-primary w-100 waves-effect waves-light" type="button" onclick="reset_password()" >Reset</button>
                                                </div>
                                            </form>
                                        <?php } else if ($check_link['status'] == 0) { ?>
                                            <div class="alert alert-danger text-center mb-4 mt-4 pt-2" role="alert">
                                               Anda belum melakukan reset password !!!
                                            </div>
                                        <?php } else { ?>
                                            <div class="alert alert-warning text-center mb-4 mt-4 pt-2" role="alert">
                                               Anda sudah melakukan reset password pada <b><?= $check_link['date']; ?></b>
                                            </div>
                                        <?php } ?>
                                        

                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Ingat Password ?  <a href="<?= base_url(); ?>"
                                                    class="text-primary fw-semibold"> Login Disini.</a> </p>
                                        </div>
                                    </div>
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> H2HLink by AGS Team.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    <div class="row mb-4">
                                        <h4 class="card-title"><i class="bx bx-data"></i> Data Chanel</h4> <p class="card-title-desc"> Please enter input and click icon Search to display data</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <button class="btn font-16 btn-primary" id="add-item" ><i class="mdi mdi-plus-circle-outline"></i> Add Chanel</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <b><div id="modal_header"> Add Role</div></b>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 ms-lg-auto">
                                                    <div class="mt-4 mt-lg-0">
                                                        ...
                                                        <br/>
                                                        <div class="row mb-4">
                                                            <label for="horizontal-input" class="col-sm-3 col-form-label">Chanel Name</label>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="status" id="status" select-one>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
